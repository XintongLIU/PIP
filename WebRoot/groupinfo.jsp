		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">				
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="groupinfo.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="groupinfo.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Right -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-users"></i>小组实践</li>
							</ol>						
						</div>
					...
					<div class="col-lg-12">                           
							<div class="panel">                                
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-pencil"></i><span class="break"></span>团队列表</h6>
								</div>										
										...
										<table class="table table-hover">
											<thead>
												<tr>
													...
													<th style="text-align: center;">项目得分</th>
