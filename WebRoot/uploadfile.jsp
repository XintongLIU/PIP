		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">				
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="uploadfile.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="uploadfile.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Right -->
								...
								<div class="toggle active">
									...
									<div class="toggle-content">
									  <div class="form-group">
										...
										<div class="controls">
											<div id="dropzone">
												<form action="test.jsp" class="dropzone">
													<div class="fallback">
														<input name="projectfile" type="file" multiple="" />
													</div>
												</form>
											</div>
										</div>
									  ...
									  <div class="form-group">
										...
										<div class="controls">
											<div id="dropzone">
												<form action="test.jsp" class="dropzone">
													<div class="fallback">
														<input name="sourcecodefile" type="file" multiple="" />
													</div>
												</form>
											</div>
										</div>
									  ...
									  <div class="form-group">
										...
										<div class="controls">
											<div id="dropzone">
												<form action="test.jsp" class="dropzone">
													<div class="fallback">
														<input name="textfile" type="file" multiple="" />
													</div>
												</form>
											</div>
										</div>
									  ...
									  <div class="form-group">
										...
										<div class="controls">
											<div id="dropzone">
												<form action="test.jsp" class="dropzone">
													<div class="fallback">
														<input name="recordfile" type="file" multiple="" />
													</div>
												</form>
											</div>
										</div>
