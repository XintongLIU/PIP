	...
	<div class="navbar" role="navigation">
		<div class="container-fluid container-nav">
			...
			<ul class="nav navbar-nav navbar-actions navbar-left">
				<li class="visible-md visible-lg"><a href="onlinestudent.jsp#"
					id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
				<li class="visible-xs visible-sm"><a href="onlinestudent.jsp#"
					...
					<div class="sidebar-menu">
						<nav id="menu" class="nav-main" role="navigation">
							<ul class="nav nav-sidebar">
								...
								<li class="active"><a href="OnlineStudent"> <i
										class="fa fa-user" aria-hidden="true"></i><span>在线学生信息</span>
								</a></li>
								<li><a href="enterstudentinfo.jsp"> <i
										class="fa fa-pencil" aria-hidden="true"></i><span>学生信息录入</span>
								</a></li>
								<li><a href="ManageStudentInfo"> <i
										class="fa fa-briefcase" aria-hidden="true"></i><span>学生信息管理</span>
								</a></li>
								<li><a href="groupinfo.jsp"> <i class="fa  fa-users"
										aria-hidden="true"></i><span>小组实践</span>
								</a></li>
							</ul>
						</nav>
					</div>
				...
				<div class="col-md-4 col-sm-4">
					<div class="panel bk-widget bk-border-off bk-noradius">
						<div class="panel-body text-center bk-padding-off bk-wrapper">
							<img src="assets/img/flat-landscape.jpg" alt=""
						...
						<div
							...
							<small class="bk-fg-inverse">${studentID }</small>
						</div>
