		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">				
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="onlinestudent.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="onlinestudent.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Right -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-user"></i>在线学生</li>
							</ol>						
						</div>
					...
					<div class="col-md-4 col-sm-4">	
					    <div class="panel bk-widget bk-border-off bk-noradius">
								...
								<div class="panel-body bk-ltr bk-padding-bottom-10 bk-avatar80-halfdown-after text-center bk-bg-white">
									<h3 class="bk-margin-off"><strong>学生1</strong></h3>
									<small class="bk-fg-inverse">20132120XX</small>
								</div>
								<div class="panel-body bk-ltr">
									<div class="row text-center">
									    <a class="col-xs-12 bk-vcenter bk-bg-white bk-bg-darken bk-padding-top-10 bk-padding-bottom-10">
											<small class="bk-fg-inverse bk-fg-darken">IP</small>
											<h4 class="bk-margin-off-bottom">192.168.9.1</h4>
										</a>
										<a class="col-xs-12 bk-vcenter bk-bg-white bk-bg-darken bk-padding-top-10 bk-padding-bottom-10">
											<small class="bk-fg-inverse bk-fg-darken">登陆时间</small>
											<h4 class="bk-margin-off-bottom">2016-5-4 08:00</h4>
										</a>
									</div>
								</div>
						</div>
					    ...
					    <div class="panel bk-widget bk-border-off bk-noradius">
								<div class="panel-body text-center bk-padding-off bk-wrapper">
									...
									<div class="bk-avatar bk-avatar80-halfdown">
										<div class="bk-vcenter"></div>
										<a href="#">
											<img src="assets/img/avatar2.jpg" alt="" class="img-circle bk-img-80 bk-border-info bk-border-darken bk-border-3x">
										</a>
									</div>
								</div>
								<div class="panel-body bk-ltr bk-padding-bottom-10 bk-avatar80-halfdown-after text-center bk-bg-white">
									<h3 class="bk-margin-off"><strong>学生2</strong></h3>
									<small class="bk-fg-inverse">20132120XX</small>
								</div>
								<div class="panel-body bk-ltr">
									<div class="row text-center">
					    ...
					    <div class="panel bk-widget bk-border-off bk-noradius">
								<div class="panel-body text-center bk-padding-off bk-wrapper">
									...
									<div class="bk-avatar bk-avatar80-halfdown">
										<div class="bk-vcenter"></div>
										<a href="#">
											<img src="assets/img/avatar3.jpg" alt="" class="img-circle bk-img-80 bk-border-info bk-border-darken bk-border-3x">
										</a>
									</div>
								</div>
								<div class="panel-body bk-ltr bk-padding-bottom-10 bk-avatar80-halfdown-after text-center bk-bg-white">
									<h3 class="bk-margin-off"><strong>学生3</strong></h3>
									<small class="bk-fg-inverse">20132120XX</small>
								</div>
								<div class="panel-body bk-ltr">
									<div class="row text-center">
					    ...
					    <div class="panel bk-widget bk-border-off bk-noradius">
								<div class="panel-body text-center bk-padding-off bk-wrapper">
									...
									<div class="bk-avatar bk-avatar80-halfdown">
										<div class="bk-vcenter"></div>
										<a href="#">
											<img src="assets/img/avatar4.jpg" alt="" class="img-circle bk-img-80 bk-border-info bk-border-darken bk-border-3x">
										</a>
									</div>
								</div>
								<div class="panel-body bk-ltr bk-padding-bottom-10 bk-avatar80-halfdown-after text-center bk-bg-white">
									<h3 class="bk-margin-off"><strong>学生4</strong></h3>
									<small class="bk-fg-inverse">20132120XX</small>
								</div>
								<div class="panel-body bk-ltr">
									<div class="row text-center">
