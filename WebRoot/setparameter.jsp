		...
		<div class="navbar" role="navigation">
			<div class="container-fluid container-nav">				
				...
				<ul class="nav navbar-nav navbar-actions navbar-left">
					<li class="visible-md visible-lg"><a href="setparameter.jsp#" id="main-menu-toggle"><i class="fa fa-th-large"></i></a></li>
					<li class="visible-xs visible-sm"><a href="setparameter.jsp#" id="sidebar-menu"><i class="fa fa-navicon"></i></a></li>			
				</ul>
				<!-- Navbar Right -->
					...
					<div class="page-header">
						<div class="pull-left">
							<ol class="breadcrumb visible-sm visible-md visible-lg">								
								...
								<li class="active"><i class="fa fa-laptop"></i>参数设置</li>
							</ol>						
						</div>
					...
					<div class="col-md-6 col-md-offset-3">
					  <div class="panel">
								<div class="panel-heading bk-bg-primary">
									<h6><i class="fa fa-indent red"></i>参数设置</h6>							
								</div>
								<div class="panel-body">
									<form action="" method="post" class="form-horizontal ">
										<div class="form-group">
											<label class="col-sm-3 control-label" for="input-normal">IP设置</label>
											<div class="col-sm-6">
												<input type="text" id="input-normal" name="input-normal" class="form-control" placeholder="IP" required="">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="input-normal">路径设置</label>
											<div class="col-sm-6">
												<input type="text" id="input-normal" name="input-normal" class="form-control" placeholder="路径" required="">
											</div>
										</div>
										<div class="col-sm-offset-4">
										<button type="submit" class="bk-margin-5 btn btn-primary col-sm-6">设置</button>
										</div>
									</form>
								</div>				
							</div>
